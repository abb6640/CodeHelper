...
export function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden relative">
            ...
            {/* Left side fashion model */}
            <div className={`absolute left-0 top-0 h-full w-1/6 transition-opacity duration-2000 ${isVisible ? 'opacity-30' : 'opacity-0'}`}>
                <img
                    src="https://images.unsplash.com/photo-1617127365659-c47fa864d8bc?w=400&h=1200&fit=crop&q=80"
                    alt=""
                    className="h-full w-full object-cover object-center"
                    style={{ maskImage: 'linear-gradient(to right, transparent, black 30%, black 70%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 30%, black 70%, transparent)' }}
                />
            </div>

            {/* Right side fashion model */}
            <div className={`absolute right-0 top-0 h-full w-1/6 transition-opacity duration-2000 delay-300 ${isVisible ? 'opacity-30' : 'opacity-0'}`}>
                <img
                    src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=1200&fit=crop&q=80"
                    alt=""
                    className="h-full w-full object-cover object-center"
                    style={{ maskImage: 'linear-gradient(to left, transparent, black 30%, black 70%, transparent)', WebkitMaskImage: 'linear-gradient(to left, transparent, black 30%, black 70%, transparent)' }}
                />
            </div>
